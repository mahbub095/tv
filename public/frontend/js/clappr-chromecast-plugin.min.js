!(function (t, e) {
  "object" == typeof exports && "object" == typeof module
    ...
    ? (exports.ChromecastPlugin = e(require("clappr")))
    : (t.ChromecastPlugin = e(t.Clappr));
})(this, function (t) {
  return (function (t) {
    function e(i) {
    ...
    function (t, e, n) {
      ...
      var a = (function () {
        ...
        C = n(21),
        M = i(C),
        E = { IDLE: 0, ACTIVE: 1, WARNING: 2, ERROR: 3 },
        A = "9DFB77C0",
        _ = {
          mp4: "video/mp4",
          ogg: "video/ogg",
      ...
      var T = (function (t) {
        function e(t) {
          r(this, e),
            s(Object.getPrototypeOf(e.prototype), "constructor", this).call(
              this,
              t
            ),
            ...
            (this.bootTryCount = 0),
            this.isBootable()
              ? ((this.appId = this.options.appId || A),
          ...
          a(
            ...
            [
              ...
              },
              {
                key: "attributes",
                get: function () {
                  return { class: "chromecast-button", type: "button" };
                },
              },
              {
                key: "events",
            ...
            [
              {
                ...
                value: function () {
                  this.listenTo(
                    ...
                    c.Events.MEDIACONTROL_RENDERED,
                    this.render
                  ),
                    c.Events.CORE_ACTIVE_CONTAINER_CHANGED
                      ? this.listenTo(
                          this.core,
                          c.Events.CORE_ACTIVE_CONTAINER_CHANGED,
                      ...
                      : this.listenTo(
                          this.core.mediaControl,
                          c.Events.MEDIACONTROL_CONTAINERCHANGED,
                          this.containerChanged
                        ),
                    this.container &&
                      (this.listenTo(
                        this.container,
                        c.Events.CONTAINER_TIMEUPDATE,
                        this.containerTimeUpdate
                      ),
                      this.listenTo(
                        this.container,
                        c.Events.CONTAINER_PLAY,
                        this.containerPlay
                      ),
                      this.listenTo(
                        this.container,
                        c.Events.CONTAINER_ENDED,
                        this.sessionStopped
                      ));
                },
              },
              {
                ...
                value: function () {
                  return (
                    !!c.Browser.isChrome &&
                    (c.Browser.version <= 71 || this.isSecure())
                  );
                },
              },
              {
              ...
              },
              {
                key: "enable",
                value: function () {
                  s(Object.getPrototypeOf(e.prototype), "enable", this).call(
                    this
                  ),
                    this.render(),
                    this.embedScript();
              ...
              },
              {
                ...
                value: function () {
                  ...
                  return (
                    this.bootTryCount++,
                    this.bootTryCount > this.bootMaxTryCount
                      ? ((this.bootTryCount = 0),
                        c.Log.warn("GCastApi bootstrap timeout"),
                        void this.disable())
                      : void (window.chrome
                          ? ((this.bootTryCount = 0),
                            window.chrome.cast && window.chrome.cast.isAvailable
                              ? ((this.appId = this.appId || A),
              ...
              },
              {
                ...
                value: function () {
                  this.session &&
                    (c.Log.debug(this.name, this.session.status),
                    this.session.status === chrome.cast.SessionStatus.STOPPED &&
                      (this.sessionStopped(), (this.session = null)));
                },
              },
              {
                key: "receiverListener",
                value: function (t) {
                  t === chrome.cast.ReceiverAvailability.AVAILABLE
                    ? (c.Log.debug(this.name, "receiver found"), this.show())
                    : (c.Log.debug(this.name, "receiver list empty"),
                      this.hide());
                },
              },
              {
                ...
                value: function (t) {
                  this.renderConnected(),
                    ...
                    c.Log.debug(
                      this.name,
                      "launch success - session: " + t.sessionId
                    ),
                    this.newSession(t);
                },
              },
              ...
              },
              {
                ...
                value: function (t, e) {
                  ...
                  var n = (0, f.default)({}, this.originalPlayback.options, {
                    currentMedia: e,
              ...
              },
              {
                ...
                value: function () {
                  ...
                  var t = this.currentTime,
                    e = void 0;
                  this.mediaSession &&
                    ((e = this.mediaSession.playerState),
                    (this.mediaSession = null)),
                    this.core.$el.removeClass("chromecast-active"),
                    this.core.load(this.src || this.core.options.sources);
                  var n = this.container;
                  this.playbackProxy &&
                    ((this.playbackProxy.isPlaying() || "PAUSED" === e) &&
                      n.once(c.Events.CONTAINER_READY, function () {
                        n.play(), n.playback.seek((100 * t) / n.getDuration());
                      }),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  return (
                    (n.title = this.options.media.title),
                    (n.subtitle = this.options.media.subtitle),
                    (n.releaseDate = this.options.media.releaseDate),
                    t === e.TvShow
                      ? ((n.episode = this.options.media.episode),
                        (n.originalAirdate =
                          this.options.media.originalAirdate),
                        (n.season = this.options.media.season),
                        (n.seriesTitle = this.options.media.seriesTitle))
                      : t === e.Movie && (n.studio = this.options.media.studio),
                    this.options.media.images &&
                      (n.images = this.options.media.images.map(function (t) {
                        return new chrome.cast.Image(t);
                      })),
                    !n.images &&
                      this.options.poster &&
                      (n.images = [new chrome.cast.Image(this.options.poster)]),
                    !n.images &&
                      this.core.options.poster &&
                      (n.images = [
                        new chrome.cast.Image(this.core.options.poster),
                      ]),
                    n
                  );
                },
              ...
              },
              {
                ...
                value: function () {
                  !this.session ||
                    (this.mediaSession &&
                      "IDLE" !== this.mediaSession.playerState &&
                      "PAUSED" !== this.mediaSession.playerState) ||
                    (c.Log.debug(this.name, "load media"), this.loadMedia());
                },
              },
              {
                key: "renderConnected",
        ...
        p = (function (t) {
          function e(t) {
            ...
            this.settings.default &&
              (this.settings.default = this.settings.default.filter(i)),
              this.settings.left &&
                (this.settings.left = this.settings.left.filter(i)),
              this.settings.right &&
                (this.settings.right = this.settings.right.filter(i));
          }
          return (
            o(e, t),
            a(e, [
            ...
            a(e, [
              ...
              },
              {
                ...
                value: function () {
                  this.stopTimer(),
                    ...
                    this.getPlaybackType() === c.Playback.LIVE &&
                      this.trigger(c.Events.PLAYBACK_DVR, !0);
                },
              },
              {
                key: "stop",
                value: function () {
                  this.stopTimer(), this.currentMedia.pause();
                },
              },
              {
                key: "seek",
                value: function (t) {
                  ...
                  (n.currentTime = t),
                    ...
                    this.getPlaybackType() === c.Playback.LIVE &&
                      this.trigger(
                        c.Events.PLAYBACK_DVR,
                        t < this.getDuration() - 30
                      );
                },
              },
              {
              ...
              },
              {
                ...
                value: function () {
                  return (
                    "PLAYING" === this.currentMedia.playerState ||
                    "BUFFERING" === this.currentMedia.playerState
                  );
                },
              },
              {
                key: "getPlaybackType",
                value: function () {
                  return this.currentMedia.liveSeekableRange
                    ? c.Playback.LIVE
                    : c.Playback.VOD;
                },
              },
              {
                ...
                value: function () {
                  this.mediaControl.changeTogglePlay(),
                    ...
                    "BUFFERING" === this.currentMedia.playerState
                      ? ((this.isBuffering = !0),
                        this.trigger(c.Events.PLAYBACK_BUFFERING, this.name))
                      : "PLAYING" === this.currentMedia.playerState
                      ? (this.isBuffering &&
                          ((this.isBuffering = !1),
                          this.trigger(
                            c.Events.PLAYBACK_BUFFERFULL,
                            this.name
                          )),
                        this.prevState !== this.currentMedia.playerState &&
                          this.trigger(c.Events.PLAYBACK_PLAY, this.name))
                      : "IDLE" === this.currentMedia.playerState
                      ? (this.isBuffering &&
                          ((this.isBuffering = !1),
                          this.trigger(
                            c.Events.PLAYBACK_BUFFERFULL,
                        ...
                        this.trigger(c.Events.PLAYBACK_ENDED, this.name))
                      : "PAUSED" === this.currentMedia.playerState &&
                        this.prevState !== this.currentMedia.playerState &&
                        this.trigger(c.Events.PLAYBACK_PAUSE, this.name),
                    (this.prevState = this.currentMedia.playerState);
                },
              },
              {
    ...
    function (t, e) {
      t.exports =
        "<div class=chromecast-playback-background></div><div class=chromecast-playback-overlay></div>";
    },
    function (t, e, n) {
      (e = t.exports = n(5)()),
        e.push([
    ...
    function (t, e, n) {
      ...
      function o(t, e) {
        return (
          (t = "number" == typeof t || d.test(t) ? +t : -1),
          (e = null == e ? y : e),
          t > -1 && t % 1 == 0 && t < e
        );
      }
      ...
      function i(t) {
        return a(function (e, n) {
          ...
          for (
            "function" == typeof s
              ? ((s = r(s, u, 5)), (a -= 2))
              : ((s = "function" == typeof u ? u : void 0), (a -= s ? 1 : 0)),
              c && o(n[0], n[1], c) && ((s = a < 3 ? void 0 : s), (a = 1));
            ++i < a;
    ...
    function (t, e) {
      ...
      function r(t, e) {
        return (
          (t = "number" == typeof t || c.test(t) ? +t : -1),
          (e = null == e ? u : e),
          t > -1 && t % 1 == 0 && t < e
        );
      }
    ...
    function (t, e) {
      function n(t, e) {
        ...
        return (
          ...
          function () {
            for (
              var n = arguments, i = -1, o = r(n.length - e, 0), a = Array(o);
              ++i < o;
    ...
    function (t, e) {
      t.exports =
        '<svg xmlns="http://www.w3.org/2000/svg"><g id="Page-1" fill="none" fill-rule="evenodd"><g id="ic_cast_black_24dp"><g id="ic_remove_circle_white_24dp"><path d="M1 18v3h3c0-1.66-1.34-3-3-3zm0-4v2c2.76 0 5 2.24 5 5h2c0-3.87-3.13-7-7-7zm0-4v2c4.97 0 9 4.03 9 9h2c0-6.08-4.93-11-11-11zm20-7H3c-1.1 0-2 .9-2 2v3h2V5h18v14h-7v2h7c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2z" id="cast" fill="#000"></path><path id="bounds" d="M0 0h24v24H0z"></path></g></g></g></svg>';
    },
    function (t, e) {
      t.exports =
        '<svg xmlns="http://www.w3.org/2000/svg"><g id="Page-1" fill="none" fill-rule="evenodd"><g id="ic_cast0_black_24dp"><g id="ic_remove_circle_white_24dp"><path d="M1 18v3h3c0-1.66-1.34-3-3-3z" id="Path" fill="#000"></path><path d="M1 14v2c2.76 0 5 2.24 5 5h2c0-3.87-3.13-7-7-7z" id="Path" opacity=".3" fill="#000"></path><path d="M1 10v2c4.97 0 9 4.03 9 9h2c0-6.08-4.93-11-11-11z" id="Path" opacity=".3" fill="#000"></path><path d="M21 3H3c-1.1 0-2 .9-2 2v3h2V5h18v14h-7v2h7c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2z" id="Path" fill="#000"></path><path id="bounds" d="M0 0h24v24H0z"></path></g></g></g></svg>';
    },
    function (t, e) {
      t.exports =
        '<svg xmlns="http://www.w3.org/2000/svg"><g id="Page-1" fill="none" fill-rule="evenodd"><g id="ic_cast1_black_24dp"><g id="ic_remove_circle_white_24dp"><path d="M1 18v3h3c0-1.66-1.34-3-3-3z" id="Path" opacity=".3" fill="#000"></path><path d="M1 14v2c2.76 0 5 2.24 5 5h2c0-3.87-3.13-7-7-7z" id="Path" fill="#000"></path><path d="M1 10v2c4.97 0 9 4.03 9 9h2c0-6.08-4.93-11-11-11z" id="Path" opacity=".3" fill="#000"></path><path d="M21 3H3c-1.1 0-2 .9-2 2v3h2V5h18v14h-7v2h7c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2z" id="cast" fill="#000"></path><path id="bounds" d="M0 0h24v24H0z"></path></g></g></g></svg>';
    },
    function (t, e) {
      t.exports =
        '<svg xmlns="http://www.w3.org/2000/svg"><g id="Page-1" fill="none" fill-rule="evenodd"><g id="ic_cast2_black_24dp"><g id="ic_remove_circle_white_24dp"><path d="M1 18v3h3c0-1.66-1.34-3-3-3zM1 14v2c2.76 0 5 2.24 5 5h2c0-3.87-3.13-7-7-7z" id="Path" opacity=".3" fill="#000"></path><path d="M1 10v2c4.97 0 9 4.03 9 9h2c0-6.08-4.93-11-11-11z" id="Path" fill="#000"></path><path d="M21 3H3c-1.1 0-2 .9-2 2v3h2V5h18v14h-7v2h7c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2z" id="cast" fill="#000"></path><path id="bounds" d="M0 0h24v24H0z"></path></g></g></g></svg>';
    },
    function (t, e) {
      t.exports =
        '<svg xmlns="http://www.w3.org/2000/svg"><g id="Page-1" fill="none" fill-rule="evenodd"><g id="ic_cast_connected_black_24dp"><g id="ic_remove_circle_white_24dp"><path d="M1 18v3h3c0-1.66-1.34-3-3-3zm0-4v2c2.76 0 5 2.24 5 5h2c0-3.87-3.13-7-7-7zm18-7H5v1.63c3.96 1.28 7.09 4.41 8.37 8.37H19V7zM1 10v2c4.97 0 9 4.03 9 9h2c0-6.08-4.93-11-11-11zm20-7H3c-1.1 0-2 .9-2 2v3h2V5h18v14h-7v2h7c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2z" id="cast-on" fill="#000"></path><path id="bounds" d="M0 0h24v24H0z"></path></g></g></g></svg>';
    },
  ]);
});
